  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <motion.div 
          ref={containerRef}
          className="grid grid-cols-1 gap-4 auto-rows-[160px] lg:grid-cols-12"
          variants={containerVariants}
          initial="hidden"
          animate={isInView ? 'visible' : 'hidden'}
        >
            {/* 1) Name: colSpan=4, rowSpan=2 (left top, smaller width) */}
            <motion.div variants={cardVariants} className="col-span-12 lg:col-span-4 row-span-2 lg:col-start-1 lg:row-start-1">
              <BentoCard
                className="flex flex-col justify-end h-full lg:min-h-[336px] lg:max-h-[336px]"
              >
                {/* Availability badge */}
            ...
            <motion.div variants={cardVariants} className="col-span-12 lg:col-span-3 row-span-3 lg:col-start-5 lg:row-start-1">
              <BentoCard
                noPadding
                className="relative overflow-hidden h-full lg:min-h-[512px] lg:max-h-[512px]"
              >
            ...
            <motion.div variants={cardVariants} className="col-span-12 lg:col-span-5 row-span-4 lg:col-start-8 lg:row-start-1">
              <BentoCard
                className="flex flex-col h-full lg:min-h-[688px] lg:max-h-[688px]"
              >
            ...
            <motion.div variants={cardVariants} className="col-span-12 lg:col-span-4 row-span-2 lg:col-start-1 lg:row-start-3">
              <BentoCard
                className="flex flex-col justify-start h-full lg:min-h-[336px] lg:max-h-[336px] pt-4! px-6! pb-8! md:px-8! md:pb-8!"
              >
            ...
            <motion.div variants={cardVariants} className="col-span-12 lg:col-span-3 row-span-1 lg:col-start-5 lg:row-start-4">
              <BentoCard
                noPadding
                className="group relative h-full lg:min-h-[160px] lg:max-h-[160px] hover:bg-[#1A1A1A] transition-colors duration-300"
              >
                <a
                  href={mailtoHref}
